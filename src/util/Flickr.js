export function getFlickrData() {
  return (
    ...
    // 20 per page
    fetch(
      "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=f7322df1cd1f8f5d748e7bc1759ffc3c&text=caesars+palace&format=json&safe_search=2&privacy_filter=1&content_type=1&per_page=12"
    )
      .then(response => {
